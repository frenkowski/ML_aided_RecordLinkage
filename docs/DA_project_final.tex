...
\subsection{Chapter 1: Record Linkage}\label{chapter-1-record-linkage}}
...
probability that P(x\_i=1\textbar{}Non-Match)
    ...
    \begin{Verbatim}[commandchars=\\\{\}]
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{p probability P(Match):}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{nb\PYZus{}full}\PY{o}{.}\PY{n}{p}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{m probabilities P(x\PYZus{}i=1|Match):}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{nb\PYZus{}full}\PY{o}{.}\PY{n}{m\PYZus{}probs}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{u probabilities P(x\PYZus{}i=1|Non\PYZhy{}Match):}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{nb\PYZus{}full}\PY{o}{.}\PY{n}{u\PYZus{}probs}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{p}{)}
\PY{n+nb}{print}\PY{p}{(}\PY{l+s+s2}{\PYZdq{}}\PY{l+s+s2}{weights of features:}\PY{l+s+s2}{\PYZdq{}}\PY{p}{,} \PY{n}{nb\PYZus{}full}\PY{o}{.}\PY{n}{weights}\PY{p}{)}
\end{Verbatim}
...
ones (Naive Bayes and ECM)
    ...
    \begin{figure}
\centering
\includegraphics{attachment:Schermata\%202020-02-15\%20alle\%2011.43.22.png}
